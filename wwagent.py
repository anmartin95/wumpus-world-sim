"""
Wumpus World Agent by Amanda Martin
...
class WWAgent:
    ...
    def __init__(self):
        ...
        self.visited = [] # list of rooms that have already been visited
    ...
    # function for steps taken once a valid 'move' has been found
    def move(self, room):
    ...
    def action(self):
        ...
        if self.unvisited:
            ...
            for move in self.unvisited:
                max = 0
                if self.ptable[move[0]][move[1]] > max:
                    max = self.ptable[move[0]][move[1]]
                    newMove = move
            if newMove:
